#NOW LOG ID FOR LOGARITHMIC ANALYSIS
import pandas as pd
...
#print(df['red_h'])
Wdata = df.loc[df['expansion'].isin(['RAV'])]
Bdata = df.loc[df['expansion'].isin(['GPT'])]
Rdata = df.loc[df['expansion'].isin(['DIS'])]
Gdata = df.loc[df['expansion'].isin(['RTR'])]
Udata = df.loc[df['expansion'].isin(['GTC'])]
RWdata = df.loc[df['expansion'].isin(['DGM'])]
